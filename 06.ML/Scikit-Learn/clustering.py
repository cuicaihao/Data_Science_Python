...
Example Data
============
The example is from https://archive.ics.uci.edu/ml/machine-learning-databases/water-treatment/water-treatment.data
...
def plot(Xs, predictions):
    ...
    for row, (row_label, X_x, X_y) in enumerate(Xs):
        for col, (col_label, y_pred) in enumerate(predictions):
            ...
            plt.scatter(X_x, X_y, c=y_pred.astype(float), cmap="prism", alpha=0.5)
...
if __name__ == "__main__":
    ...
    print(
        "Processing {} samples with {} attributes".format(
